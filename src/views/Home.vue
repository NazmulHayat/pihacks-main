<template>
  <div class="home">
    ...
    <Timer/>
    <TypeWriter/>
    <div class="main-text pl-16 pr-16 pb-14">
        <div class="main-head text-h4 font-weight-medium">About PIHACKS</div>
        <div class="white--text text-h4 font-weight-medium pt-4">
            <p class="p1">
...
export default {
  components: {Carousel, Timer, TypeWriter, Schedule},
  data: () => ({
...
<style>
    ...
    @import url('https://fonts.googleapis.com/css2?family=Bree+Serif&display=swap');
    @import url('https://fonts.googleapis.com/css2?family=Bree+Serif&family=Open+Sans:wght@600&display=swap');
    .main-text{
        /* padding-left: 150px; */
        /* padding-right: 150px; */
        /* padding-top: 50px; */
